...
export const Introduction = () => {
  return (
    <section className="bg-gray-800">
      <div className="w-4/5 max-w-7xl mx-auto flex flex-col justify-center items-center py-28 gap-2 overflow-hidden">
        ...
        <h3 className="text-center text-2xl md:text-4xl text-cyan-500 font-light tracking-wider">
          Build and read the blog of your dreams
        </h3>
      </div>
    </section>
  );
